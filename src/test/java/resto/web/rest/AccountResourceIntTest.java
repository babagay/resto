package resto.web.rest;

import resto.config.Constants;
import resto.RestoApp;
import resto.domain.Authority;
import resto.domain.User;
import resto.repository.AuthorityRepository;
import resto.repository.UserRepository;
import resto.security.AuthoritiesConstants;
import resto.service.MailService;
import resto.service.dto.UserDTO;
import resto.web.rest.errors.ExceptionTranslator;
import resto.web.rest.vm.KeyAndPasswordVM;
import resto.web.rest.vm.ManagedUserVM;
import resto.service.UserService;
...
@SpringBootTest(classes = RestoApp.class)
